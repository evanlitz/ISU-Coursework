...
# Compute and display team strengths
teams <- data.frame(
...
ggplot(teams, aes(x = strength, y = names)) +
  geom_bar(stat = "identity") +
  labs(x = 'Strength', y = 'Team', title = '2022 NFL Team Strengths')
...
# Compute probabilities for two equal-strength teams
equal_strength_probs <- calculate_ordinal_probabilities(0, thresholds)

# Output all estimated probabilities
cat("Estimated probability of home team winning when teams are equal in strength:", equal_strength_probs["Win"], "\n")
cat("Estimated probability of the game ending in a tie:", equal_strength_probs["Tie"], "\n")
cat("Estimated probability of the home team losing:", equal_strength_probs["Loss"], "\n")
